...
## Outputs
- Daily digest: `~/multi-agent-intelligence/shared/sentinel-output/digest-{date}.md`
- Latest digest pointer: `~/multi-agent-intelligence/shared/sentinel-output/digest-latest.md`
- Latest digest metadata: `~/multi-agent-intelligence/shared/sentinel-output/manifest-latest.json`
- Weekly memo: `~/multi-agent-intelligence/shared/sentinel-output/memo-week-{date}.md`
