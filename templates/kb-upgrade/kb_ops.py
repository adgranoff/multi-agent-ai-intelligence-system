...
from common import default_kb_root, dump_frontmatter, find_api_key, list_entity_files, load_json, parse_frontmatter, provider_api_url, save_json, slugify, utc_now_iso  # noqa: E402
...
def _generate_weekly_memo(kb_root: Path) -> Path:
    ...
    if not key:
        ...
        try:
            resp = requests.post(provider_api_url("chat/completions"), headers=headers, json=payload, timeout=180)
